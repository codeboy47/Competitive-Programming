/* To run in 1sec you have to store previous result before going into main loop
	always consider this fact that  your algo should not do that work it has done previously. 
	For that try to store that previous result somewhere like in array
*/
